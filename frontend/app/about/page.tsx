    ...
    <main className="relative min-h-screen bg-background">
      ...
      <section className="relative z-10 flex min-h-screen w-full flex-col items-center px-4 pt-32 pb-20">
        <div className="w-full max-w-7xl">
          ...
          {/* Content Card */}
          <div className="flex flex-col gap-0 overflow-hidden rounded-2xl bg-card/60 backdrop-blur-sm lg:flex-row">
            {/* Left Side - Profile Card */}
            <div className="flex flex-col items-center p-8 lg:w-2/5 lg:items-start">
              {/* Profile Image */}
            ...
            <div className="flex flex-col justify-center p-8 lg:w-3/5 lg:p-12">
              ...
              <p className="mb-6 text-base leading-relaxed text-foreground/70">
                "I'm a first-year BSc Mathematics with Data Science student at the London School of Economics with a strong interest in how technology is applied across finance. I enjoy working with data and especially enjoy building data pipelines and the ETL process. In finance, I enjoy learning about the macro environment, and how this affects financial markets. Building projects like this allows me to both build my technical skills and improve my financial domain knowledge.
              </p>

              <h3 className="mb-4 text-2xl font-bold text-foreground">Why YieldLabs?</h3>
              <p className="mb-6 text-base leading-relaxed text-foreground/70">
                I built YieldLabs as a way to develop my knowledge of fixed income. This was a topic I first learned about at a university society, and initially I found the distinction between coupons and yields unintuitive to understand. After reading up on it, I got an idea to implement this with technology, and throughout the process of building YieldLabs, I've been able to expand on this knowledge and learn a lot more in the process.
              </p>
            </div>
          </div>
        </div>
