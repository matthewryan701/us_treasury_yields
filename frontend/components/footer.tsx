    ...
    <footer className="relative z-10 border-t border-foreground/10 bg-background px-4 pt-16 pb-8">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-2 gap-12 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/valuation" className="text-sm text-foreground/60 hover:text-foreground transition-colors">
                  Valuation
                </Link>
              </li>
              <li>
                <Link href="/duration" className="text-sm text-foreground/60 hover:text-foreground transition-colors">
                  Duration
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="https://www.python.org/" target="_blank" rel="noopener noreferrer" className="text-sm text-foreground/60 hover:text-foreground transition-colors">
                  Python
                </a>
              </li>
              <li>
                <a href="https://nextjs.org/" target="_blank" rel="noopener noreferrer" className="text-sm text-foreground/60 hover:text-foreground transition-colors">
                  Next.js
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 flex items-center justify-between border-t border-foreground/10 pt-8">
          ...
          <span className="text-sm text-foreground/50">&copy; {new Date().getFullYear()} YieldLabs.</span>
        </div>
      </div>
    </footer>
  )
